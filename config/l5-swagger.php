    ...
    'documentations' => [
        'default' => [
            ...
            'paths' => [
                ...
                */
                'swagger_ui_assets_path' => env('L5_SWAGGER_UI_ASSETS_PATH', 'https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/'),
    ...
    'defaults' => [
        ...
        */
        'securityDefinitions' => [
            ...
            'security' => [
                // Aquí no incluimos seguridad por defecto
                // Cada endpoint especifica si requiere autenticación con #[OA\SecurityScheme(...)]
            ],
        ],

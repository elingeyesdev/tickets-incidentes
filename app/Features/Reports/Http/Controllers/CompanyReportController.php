...
use App\Features\CompanyManagement\Models\CompanyArea;
...
class CompanyReportController
{
    ...
    public function summaryPdf(Request $request)
    {
        ...
        $config = [
            ...
            'total_areas' => CompanyArea::where('company_id', $companyId)->count(),
            'active_areas' => CompanyArea::where('company_id', $companyId)->where('is_active', true)->count(),
        ];

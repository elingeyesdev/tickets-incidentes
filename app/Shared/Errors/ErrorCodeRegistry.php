 ...
 * Error Code Registry
 *
 * Registro AGNÓSTICO de códigos de error (NO específico de GraphQL ni REST).
 * Usado por ambos GraphQL y REST para consistencia.
 *
 * Cuando se elimine GraphQL, este archivo se queda porque los códigos
 * son del negocio, no de la implementación.
 *
 * Códigos basados en:
 * - GraphQL Spec
 * - Apollo Error Codes

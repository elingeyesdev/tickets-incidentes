...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("COMMENT ON COLUMN ticketing.ticket_ratings.rated_by_user_id IS 'Cliente que calificó'");
        ...
        DB::statement("CREATE INDEX idx_ticket_ratings_rated_by_user_id ON ticketing.ticket_ratings(rated_by_user_id)");

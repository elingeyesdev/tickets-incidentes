    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
        ...
        <span class="brand-image elevation-3 d-inline-flex align-items-center justify-content-center"
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    d="M12 3C7.03 3 3 7.03 3 12V18C3 19.1 3.9 20 5 20H7C7.55 20 8 19.55 8 19V14C8 13.45 7.55 13 7 13H5V12C5 8.13 8.13 5 12 5C15.87 5 19 8.13 19 12V13H17C16.45 13 16 13.45 16 14V19C16 19.55 16.45 20 17 20H19C20.1 20 21 19.1 21 18V12C21 7.03 16.97 3 12 3Z"
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img id="sidebar-user-avatar"
                    src="https://ui-avatars.com/api/?name=User&background=6c757d&color=fff&size=160"
                    ...
                    <div>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/app/admin/reports/companies" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Empresas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/app/admin/reports/growth" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Crecimiento</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/app/admin/reports/requests" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Solicitudes</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/app/admin/reports/apikeys" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>API Keys</p>
                                    </a>
                                </li>
